...
=for git $Id: Basics.pod f023df4 2009-09-06 14:07:30Z sanko@cpan.org $
...
ones you need. In this case C<run> is included automatically as it is in the
C<:default> tag. The C<:default> tag contans most functions needed by the main
part of a program to get FLTK to run.
