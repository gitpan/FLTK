...
=for git $Id: FLTK.pm 3d6d95a 2011-02-02 21:48:26Z sanko@cpan.org $

=cut

    use strict;
    use warnings;
    our $MAJOR = 532; our $MINOR = 7; our $DEV = 0; our $VERSION = sprintf('%1.3f%03d' . ($DEV ? (($DEV < 0 ? '' : '_') . '%03d') : ('')), $MAJOR / 1000, $MINOR, abs $DEV);
    use XSLoader;
