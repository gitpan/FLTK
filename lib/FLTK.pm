...
=for git $Id: FLTK.pm aaba4c5 2009-10-30 21:00:54Z sanko@cpan.org $

=cut

use strict;
use warnings;
our $VERSION_BASE = 530; our $UNSTABLE_RELEASE = 5; our $VERSION = sprintf(($UNSTABLE_RELEASE ? '%.3f_%03d' : '%.3f'), $VERSION_BASE / 1000, $UNSTABLE_RELEASE);
use XSLoader;
