...
=for git $Id: FLTK.pm c9b696e 2009-11-05 18:41:28Z sanko@cpan.org $

=cut

use strict;
use warnings;
our $VERSION_BASE = 530; our $UNSTABLE_RELEASE = 10; our $VERSION = sprintf(($UNSTABLE_RELEASE ? '%.3f_%03d' : '%.3f'), $VERSION_BASE / 1000, $UNSTABLE_RELEASE);
use XSLoader;
