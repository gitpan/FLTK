...
=for git $Id: FLTK.pm 8133705 2009-11-06 03:10:41Z sanko@cpan.org $

=cut

use strict;
use warnings;
our $VERSION_BASE = 531; our $UNSTABLE_RELEASE = 0; our $VERSION = sprintf(($UNSTABLE_RELEASE ? '%.3f_%03d' : '%.3f'), $VERSION_BASE / 1000, $UNSTABLE_RELEASE);
use XSLoader;
