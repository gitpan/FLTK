...
=item C<my $self = $togglebutton-E<gt>new( $x, $y, $w, $h, $label );>X<my_self_togglebutton_E_gt_new_x_y_w_h_label_>
...
=for hackers xs/ToggleButton.xs line 36
...
=for git $Id: ToggleButton.xs 7483df2 2011-04-09 05:42:22Z sanko@cpan.org $
