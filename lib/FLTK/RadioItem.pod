...
=item C<my $self = $radioitem-E<gt>new( $label );>X<my_self_radioitem_E_gt_new_label_>
...
=for hackers xs/RadioItem.xs line 33

=item C<my $self = $radioitem-E<gt>new( $label, $shortcut, \&callback, $user_data, $flags );>X<my_self_radioitem_E_gt_new_label_shortcut_callback_user_data_flags_>
...
=for hackers xs/RadioItem.xs line 38
...
=for git $Id: RadioItem.xs 7483df2 2011-04-09 05:42:22Z sanko@cpan.org $
