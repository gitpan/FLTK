...
=for git $Id: FLTK.pm e601e5e 2011-01-28 04:08:37Z sanko@cpan.org $

=cut

    use strict;
    use warnings;
    our $MAJOR = 532; our $MINOR = 6; our $DEV = 3; our $VERSION = sprintf('%1.3f%03d' . ($DEV ? (($DEV < 0 ? '' : '_') . '%03d') : ('')), $MAJOR / 1000, $MINOR, abs $DEV);
    use XSLoader;
